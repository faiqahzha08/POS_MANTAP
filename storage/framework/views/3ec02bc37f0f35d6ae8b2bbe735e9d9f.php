...
<?php $__env->startSection('content'); ?>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 card-hover">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-slate-900"><?php echo e($totalTransaksi ?? 0); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 card-hover">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-slate-900">Rp <?php echo e(number_format($totalOmzet ?? 0, 0, ',', '.')); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 card-hover">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-slate-900"><?php echo e($hariIni ?? 0); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/80 transition">
                        <td class="px-6 py-4 text-slate-500"><?php echo e($penjualans->firstItem() + $index); ?></td>
                        ...
                        <td class="px-6 py-4 text-right font-semibold text-slate-800">
                            Rp <?php echo e(number_format($penjualan->total ?? 0, 0, ',', '.')); ?>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <form action="<?php echo e(route('penjualan.destroy', $penjualan->id)); ?>" method="POST" onsubmit="return confirm('Yakin hapus transaksi ini?')">
                                    <?php echo csrf_field(); ?>
        ...
        <?php if(isset($penjualans) && method_exists($penjualans, 'links')): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\APK_POS_faiq\resources\views/penjualan/index.blade.php ENDPATH**/ ?>